...
export const useNewRecetaSchema = (data) => {
  ...
  const recetaSchema = z.object({
    paraAfiliado: z.string().min(1, ERROR_MESSAGES.AFILIADO.REQUIRED),
    medicamento: z
      .string()
      .trim()
    ...
    cantidad: z
      .number({ invalid_type_error: ERROR_MESSAGES.CANTIDAD.REQUIRED })
      .int(ERROR_MESSAGES.CANTIDAD.INTEGER)
      .positive(ERROR_MESSAGES.CANTIDAD.NEGATIVE),
    presentacion: z
      .string()
      .trim()
    ...
    observaciones: z
      .string()
      .trim()
      .max(100, ERROR_MESSAGES.OBSERVACIONES.TOO_LONG)
      .optional(),
  });
