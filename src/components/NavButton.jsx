...
const variants = cva(['p-3 inline-flex min-w-28 h-[41px] justify-center items-center gap-3 shadow-custom-shadow rounded-lg border'], {
  variants: {
    state: {
      idle: ['border-gris-border bg-blanco-principal hover:text-menta-200 cursor-pointer hover:border-menta-200 transition-all'],
      active: ['bg-menta-600 text-blanco-principal border-menta-600 pointer-events-none']
    }
  },
  defaultVariants: {
    state: 'idle'
